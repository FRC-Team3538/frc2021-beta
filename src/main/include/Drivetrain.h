...
class Drivetrain {
 public:
  ...
  units::meter_t GetPositionLeft();
  units::meter_t GetPositionRight();

  units::meters_per_second_t GetRateLeft();
  units::meters_per_second_t GetRateRight();

  void SetPositionLeft(units::meter_t in);
  void SetPositionRight(units::meter_t in);

 private:
  static constexpr units::meter_t kTrackWidth = 0.381_m * 2;
  static constexpr units::meter_t kWheelRadius = 0.0508_m;
  static constexpr int kEncoderResolution = 4096;
  static constexpr units::meter_t kScaleFactor = 2 * wpi::math::pi * kWheelRadius / kEncoderResolution;
